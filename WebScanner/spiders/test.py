...
class PachSpider(scrapy.Spider):                            #定义爬虫类，必须继承scrapy.Spider
    name = 'pach'                                           #设置爬虫名称
    allowed_domains = ['192.168.177.161']                    #爬取域名
    ...
    def start_requests(self):
        ...
        return [Request('http://192.168.177.161/dvwa/login.php',meta={'cookiejar':1},callback=self.parse)]
    ...
    def parse(self, response):
        ...
        return [FormRequest.from_response(response,
                                          url='http://192.168.177.161/dvwa/login.php',                        #真实post地址
    ...
    def next(self,response):
        ...
        yield Request('http://192.168.177.161/dvwa/login.php',meta={'cookiejar':True},callback=self.next2)
